...
<head>
    ...
    <title>@yield('title', 'EV Route Planner - Station Owner')</title>
...
<body>
    <nav class="navbar navbar-expand app-navbar px-3 py-2">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('station-owner.overview') }}">
                <i class="bi bi-ev-station-fill fs-4"></i> EV Route Planner
            </a>

            <button class="btn btn-accent d-lg-none" type="button"
                    data-bs-toggle="collapse" data-bs-target="#stationOwnerSidebar" aria-controls="stationOwnerSidebar">
    ...
    <div class="app-shell">
        <aside class="app-sidebar collapse d-lg-block" id="stationOwnerSidebar">
            <nav class="nav flex-column py-3">
                @foreach ([
                    ['route' => 'station-owner.overview', 'icon' => 'speedometer2', 'label' => 'Overview'],
                    ['route' => 'station-owner.stations', 'icon' => 'ev-station', 'label' => 'My Stations'],
                    ['route' => 'station-owner.notifications', 'icon' => 'bell', 'label' => 'Notifications'],
